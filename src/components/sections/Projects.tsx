  ...
  return (
    <section className="py-16 md:py-20 px-6 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Web Projects - Indigo Border */}
        <h3 className="text-2xl font-bold text-slate-800 dark:text-white mb-4 border-b-2 border-indigo-300 dark:border-indigo-700 pb-2">
          🌐 Web Projects <span className="text-sm font-normal text-slate-500 dark:text-slate-400">(Group)</span>
        </h3>
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {webProjects.map((project, index) => (
            <div key={index} className="dark-card-blue bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md dark:shadow-slate-800/50 border-l-8 border-indigo-600 dark:border-indigo-400 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
