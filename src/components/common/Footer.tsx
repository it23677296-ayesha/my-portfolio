  ...
  return (
    <footer className="bg-slate-950 text-slate-400 py-10 px-6 border-t border-slate-800">
      <div className="max-w-4xl mx-auto text-center">
        <span className="inline-block bg-slate-800 text-slate-300 px-5 py-2 rounded-full text-sm font-semibold mb-5">
        ...
        <p className="text-sm opacity-75 text-slate-500">
